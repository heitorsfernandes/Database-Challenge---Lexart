...
--
-- Host: 192.168.30.23
-- Tempo de geração: 19/07/2023 às 21:20
...
--
-- Estrutura para tabela `averageLifeExpectancy`
--

CREATE TABLE `averageLifeExpectancy` (
  `LifeProm` decimal(5,0) DEFAULT NULL,
  `Region` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Despejando dados para a tabela `averageLifeExpectancy`
--

INSERT INTO `averageLifeExpectancy` (`LifeProm`, `Region`) VALUES
(73, 'North America'),
(67, 'Asia'),
(53, 'Africa'),
(75, 'Europe'),
...
--
-- Estrutura para tabela `countrylanguage`
--
...
--
-- Despejando dados para a tabela `countrylanguage`
--
...
--
-- Índices de tabela `countrylanguage`
--
...
--
-- Restrições para tabelas `countrylanguage`
--
ALTER TABLE `countrylanguage`
